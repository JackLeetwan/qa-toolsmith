...
export const generatorsMeta: GeneratorMeta[] = [
  ...
  },
  {
    kind: "phone",
    name: "Phone Number",
    description: "Generate realistic phone numbers (mobile or landline) for Poland, Germany, and Austria.",
  ...
  },
  {
    kind: "address",
    name: "Address",
    description: "Generate realistic addresses (home or business) with street, city, and postal code.",
  ...
  },
  {
    kind: "plates",
    name: "License Plate",
    description: "Generate valid license plate numbers in country-specific formats.",
  ...
  },
  {
    kind: "card",
    name: "Payment Card",
    description: "Generate valid test payment card numbers (Visa, Mastercard) with Luhn checksum.",
